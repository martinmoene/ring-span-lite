...
"%clang%" -std=%std% -O2 -Wall -Wextra -Wno-unused-parameter %flags% -Dlest_FEATURE_COLOURISE=0 -fms-compatibility-version=19.00 -isystem "%VCInstallDir%include" -isystem "%WindowsSdkDir_71A%include" -I../include/nonstd -o ring-span-main.t.exe -I../include/nonstd ring-span-main.t.cpp ring-span.t.cpp && ring-span-main.t.exe
endlocal
